...
Student Name: Asmi Baidya Roll Number: 05 Date: 27th Dec 2025
...
•	Traffic Generator (traffic_generator.c, traffic_generator.h): Randomly generates vehicles and assigns them to lanes, writing them to the shared file and enqueuing them.
...
Mutexes (SDL_mutex) ensure safe concurrent access to queues.
